...
% Last Modified by GUIDE v2.5 01-Apr-2017 22:21:24
...
function perceptronPageButton_Callback(hObject, eventdata, handles)
close(mainMenu)
perceptronPage

function PerceptronLearningPageButton_Callback(hObject, eventdata, handles)
close(mainMenu)
perceptronLearningPage
